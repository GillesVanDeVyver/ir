...
//		}
		...
		int N = noOfDocs*m;
		double goodness;
//		goodness = iterateMC1(noOfDocs,N, c);
//		goodness = iterateMC2(noOfDocs,m, c);
//		goodness = iterateMC4(noOfDocs,m, c);
//		goodness = iterateMC5(noOfDocs,N, c);	
//		System.out.println("(inverse of) goodness: " + goodness);
